...
import com.vaultbeat.ui.library.LibraryScreen
import com.vaultbeat.ui.library.LibraryViewModel
import com.vaultbeat.ui.nowplaying.NowPlayingScreen
import com.vaultbeat.ui.nowplaying.NowPlayingViewModel
import com.vaultbeat.ui.theme.VaultBeatTheme
...
private fun PermissionScreen(onRequestPermission: () -> Unit) {
    Column(
        ...
        Text(stringResource(R.string.permission_desc), color = MaterialTheme.colorScheme.onSurfaceVariant)
        Spacer(Modifier.height(24.dp))
        Button(onClick = onRequestPermission) { Text(stringResource(R.string.permission_button)) }
    }
}
